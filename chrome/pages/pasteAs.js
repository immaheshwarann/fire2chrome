...
$(async () => {
  ...
  let pasteAsHTML = chrome.i18n.getMessage("pasteAsHTML");
  let pasteAsPlain = chrome.i18n.getMessage("pasteAsPlain");
  let pasteAsPlainHTML = chrome.i18n.getMessage("pasteAsPlainHTML");
