...
aeCopyClippingTextFormatDlg.onFirstInit = async function ()
{
  ...
  let copyAsHTML = chrome.i18n.getMessage("copyAsHTML");
  let copyAsPlain = chrome.i18n.getMessage("copyAsPlain");
  let copyAsPlainHTML = chrome.i18n.getMessage("copyAsPlainHTML");
