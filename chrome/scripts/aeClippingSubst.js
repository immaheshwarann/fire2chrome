...
aeClippingSubst.init = async function (aUserAgentStr, aAutoIncrementStartVal)
{
  ...
  // chrome.runtime.getBrowserInfo() is Firefox-only; derive host app name from
  // the user-agent string instead.
  this._hostAppName = navigator.userAgent.includes("Chrome") ? "Chrome" : "Chromium";
